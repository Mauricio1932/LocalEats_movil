      ...
      body: Center(
        ...
        child: BlocBuilder<LocalesBloc, LocalesState>(
          builder: (context, state) {
            ...
            return Text("${state.locales.length}");
            ...
            //           print("ayuda ${state.locales.length}");
            ...
            //                               .urlImage), // Utiliza NetworkImage para cargar la imagen desde la red
            //                           fit: BoxFit.contain,
            //                         ),
            //                       ),
            //                       child: Material(
            ...
            //                         image: NetworkImage(local.urlImage),
            //                         fit: BoxFit.contain,
            //                       ),
            //                     ),
            //                   ),
